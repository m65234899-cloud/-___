...
### بوت حسب طلبك وتصميمك  11M
### بوت جاهز ب اختيارك  5M
...
## (1) تصميم سيرفرك الخاص  5M
## (2) تصميم لوقو خاص فيك 1:5M
## (3) تصميم بنر خاص فيك: 2M
## (4) تصميم شعار سيرفر خاص فيك: 3M

أي شي ودك في افتح تذكرة : <#1467200591204843717>`
      )
      .setImage("https://cdn.discordapp.com/attachments/1466506501479989615/1473024559631433911/IMG_7633.png?ex=6994b486&is=69936306&hm=be6cbfe2eed9e4fec3bdd1ca2da958c6e956f0637c2b475cce2ef00d89a2d071&")
      .setColor("#00ffff");
    return message.channel.send({ embeds: [embed] });
  }
